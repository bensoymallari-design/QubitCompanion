...
import { DATABASE_PATH, NDI_PRESETS_PATH, SETTINGS_PATH, THUMBNAILS_DIR, UPLOADS_DIR } from "@/lib/constants";
...
export function ndiPresetsPath(): string {
  return resolveFromRoot(NDI_PRESETS_PATH);
}
